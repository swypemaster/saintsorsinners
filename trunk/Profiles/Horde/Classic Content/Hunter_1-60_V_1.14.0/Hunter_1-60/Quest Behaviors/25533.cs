...
{
    public class q25533 : CustomForcedBehavior
    {

        public q25533(Dictionary<string, string> args)
            : base(args)
        {
		...
		public List<WoWUnit> flyList
        {
            get
            {
                return ObjectManager.GetObjectsOfType<WoWUnit>()
                                    .Where(u => (u.Entry == 40727 && !u.Dead))
                                    .OrderBy(u => u.Distance).ToList();
            }
        }
        public List<WoWGameObject> mobList
        {
            get
            {
                return ObjectManager.GetObjectsOfType<WoWGameObject>()
                                    .Where(u => (u.Entry == 203009))
                                    .OrderBy(u => u.Distance).ToList();
            }
        }
