...
namespace VladQuesting
{
    public class VladQuesting : HBPlugin, IDisposable
    {
		#region uselessbutnecessaryshit
		public override string Name { get { return "VladQuesting"; } }
        public override string Author { get { return "Vlad"; } }
        ...
        {
            Logging.Write(Color.DarkViolet, "[VladQuesting] " + format, args);
        }
