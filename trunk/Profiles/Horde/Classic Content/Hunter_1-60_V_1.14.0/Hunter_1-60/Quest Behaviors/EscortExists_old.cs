        ...
        protected override Composite CreateBehavior()
        {
            return _root ?? (_root =
                new PrioritySelector(
                            ...
                            new Decorator(ret => me.QuestLog.GetQuestById(QuestId) != null && me.QuestLog.GetQuestById(QuestId).IsCompleted || mobList.Count == 0 || me.QuestLog.GetQuestById(QuestId).IsFailed,
                                new Sequence(
                           ...
                           new Decorator(ret => mobList.Count > 0 && (!me.Combat || me.CurrentTarget == null || me.CurrentTarget.Dead),
                                new Sequence(
